    ...
    else
    {
        ...
        else
        {
            ...
            if (!size && lpParameter)
            {
                ...
                if (size < sizeof(RequestResponseHeader) + sizeof(ExchangePublicPeers) + sizeof(RequestResponseHeader) || size < ((RequestResponseHeader*)&requestResponseBuffer[sizeof(RequestResponseHeader) + sizeof(ExchangePublicPeers)])->size())
                {
            ...
            case BN_CLICKED:
            {
                ...
                else
                {
                        ...
                        && price > 0 && price <= MAX_AMOUNT / NUMBER_OF_COMPUTORS)
                    {
                        ...
                        *((unsigned int*)request.destinationPublicKey) = QX_CONTRACT_INDEX;
                        request.amount = 0;
            ...
            else
            {
                ...
                case 1:
                {
                    if (tick != prevTick1)
                    {
                        ...
                        request.contractIndex = QX_CONTRACT_INDEX;
